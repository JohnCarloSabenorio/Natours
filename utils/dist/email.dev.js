...
function () {
  function Email(user, url) {
    ...
    this.url = url;
    this.from = "Email Sender <".concat(process.env.EMAIL_FROM, ">");
  }
  ...
  _createClass(Email, [{
      ...
      return regeneratorRuntime.async(function sendWelcome$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return regeneratorRuntime.awrap(this.send('welcome', 'WELCOME TO THE NATOURS WEBSITE!'));
    ...
    value: function sendResetPassword() {
      return regeneratorRuntime.async(function sendResetPassword$(_context3) {
        while (1) {
