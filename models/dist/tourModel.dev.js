...
var tourSchema = new mongoose.Schema({
  name: {
    ...
    validate: [validator.isAscii, 'The tour name must only contain characters from the alphabet!']
  },
  slug: {
    type: String
  },
  ...
  priceDiscount: {
    ...
    validate: {
      ...
      message: 'The discounted price ({VALUE}) must be less than the original price!'
    }
  },
  summary: {
    type: String,
...
tourSchema.post(/^find/, function (docs, next) {
  console.log("Find query took ".concat(Date.now() - this.start, " milliseconds to complete!"));
